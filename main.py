...
FACEBOOK_APP_ID = "698224480265000"
FACEBOOK_APP_SECRET = "184b165f7d4452b88be308ee5b3bc6b9"
...
class DeleteHandler(webapp2.RequestHandler):
    def get(self,id):
        post = Posts.get_by_id(long(id))
        post.key.delete()
        self.response.write("<script> alert('Successfully Deleted.');window.location.assign('/list/"+post.user_id+"')</script>")
